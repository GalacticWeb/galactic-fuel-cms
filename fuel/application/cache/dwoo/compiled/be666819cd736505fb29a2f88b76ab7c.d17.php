...
<script type="text/javascript">
	$(document).ready(function () { 
		...
		var img_path = "/fuel_template_git/assets/images/"; 
		...
		if ( slides !== null ) { 
			...
			for ( var i = 0; i < slides.length; i++ ) { 
				...
				$('<div class="item"><img src="'+slides[i]['image']+'"><div class="carousel-caption">'+slides[i]['label']+'</div></div>').appendTo('.carousel-inner');
