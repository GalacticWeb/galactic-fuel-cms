...
<body>
	...
	<header class="page_header">
		<h1><!--__FUEL_MARKER__3-->To infinity ... and beyond</h1>
	</header>	
	...
	<div class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><!--__FUEL_MARKER__4-->To infinity ... and beyond</a>
            </div>
...
<ul class="nav navbar-nav">
	...
	<!--__FUEL_MARKER__5-->This is a default layout. To change this layout go to the fuel/application/views/_layouts/main.php file.
