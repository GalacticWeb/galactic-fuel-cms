...
$config['site_name'] = 'Galactic Page';
...
$config['modules_allowed'] = array(
	// ... put the names of the modules you want to allow here
);

// dashboard modules
$config['dashboards'] = array(
	// ... put the names of the modules you want to access in the dashboard here
);
...
// place Javascript on every page	
...
// control FUEL settings in the CMS. Below are a couple examples of ones you can configure
$config['settings'] = array();
$config['settings']['site_name'] = array($config['site_name']);
