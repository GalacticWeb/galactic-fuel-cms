...
class Fuel_custom_fields {
	...
	public function asset($params)
	{
		...
		// preview image cropping feature
		//$data_params['preview_cropping'] = (isset($params['preview_cropping'])) ? (bool)$params['preview_cropping'] : FALSE;
		...
		// preview image cropping feature ('guillotine')
		if ( isset($params['preview_cropping']) && $params['preview_cropping'] == TRUE ) {
			$preview_crop_data = '1';

			// set preview crop credentials
			if ( isset($params['preview_crop_width']) ) {
				$preview_crop_width = $params['preview_crop_width'];
			} else {
				$preview_crop_width = '800';
			}
			if ( isset($params['preview_crop_height']) ) {
				$preview_crop_height = $params['preview_crop_height'];
			} else {
				$preview_crop_height = '450';
			}
			$preview = '<br /><div class="img_preview noclone" style="'.$img_container_styles.'" data-imgstyles="'.$params['img_styles'].'" data-previewcrop="'.$preview_crop_data.'" data-previewcrop-width="'.$preview_crop_width.'" data-previewcrop-height="'.$preview_crop_height.'">';

		} 
		else {
			$preview = '<br /><div class="img_preview noclone" style="'.$img_container_styles.'" data-imgstyles="'.$params['img_styles'].'" data-previewcrop="0">';
		}
