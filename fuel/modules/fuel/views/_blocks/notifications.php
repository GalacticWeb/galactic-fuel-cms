...
?>
	<div class="alert alert-sm alert-success success"><?=$success;?></div>
<?php else: ?>
	<?php echo display_errors(NULL, 'ico error ico_error')?>
<?php endif; ?>

<?php if (!empty($last_updated)) : ?>
<p class="alert alert-sm alert-info last_updated">
	<?=$last_updated?>
</p>
<?php elseif ($this->session->flashdata('info')) : ?>
<p class="alert alert-sm alert-info ico_info">
	<?=$this->session->flashdata('info');?>
</p>
<?php elseif (!empty($info)) : ?>
<p class="alert alert-sm alert-info ico_info"><?=$info?></p>
<?php endif; ?>