...
class Assets extends Module {
	...
	public function select($dir = NULL)
	{
		...
		$preview = ' OR <a href="'.fuel_url('assets/inline_create?asset_folder='.urlencode($dir).'&redirect_to='.$redirect_to).'" class="btn_field btn btn-default">Upload</a><div id="asset_preview" class="col-xs-12"></div>';
	...
	public function _form($field_values = NULL, $inline = FALSE)
	{
		...
		// Set custom data attribute for drag & drop file upload
		//$fields['userfile']['data']['form-action-path'] = 
		
		$vars['instructions'] = lang('assets_instructions');
		//$vars['form_css'] = 'dropzone';
