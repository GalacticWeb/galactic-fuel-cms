...
$config['language_default_option'] = 'german';
...
$config['assets_excluded_dirs'] = array('js', 'css', 'cache', 'swf', 'captchas', 'thumbs');
...
$config['fuel_javascript'] = array(
	...
	*/
	'fuel' => array(
	    'lightbox.min', 
	    'jquery/plugins/jquery-ui-1.11.4.custom.min', // load jquery ui components seperately...
	    'fuel/fuel.min_big',
	    'dropzone',
	    'metisMenu',
